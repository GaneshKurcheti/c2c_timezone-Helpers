...
class StoriesTest < ApplicationSystemTestCase
  ...
  test "creating a Story" do
    ...
    fill_in "Datefield", with: @story.datefield
    fill_in "Datetime Field", with: @story.datetime_field
    fill_in "Time Field", with: @story.time_field
    fill_in "Timestamp Field", with: @story.timestamp_field
